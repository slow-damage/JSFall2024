(function () {
   ...
   */
  const acceptedCookies = document.querySelector("#acceptCookiesButton");
  acceptedCookies.addEventListener("click", () => {
    acceptedCookies.parentElement.style.display = "none";
  });
  /**
